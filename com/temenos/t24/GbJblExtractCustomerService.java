...
public class GbJblExtractCustomerService extends ServiceLifecycle {
    @Override
    ...
    public void updateRecord(String id, ServiceData serviceData, String controlItem,
        ...
        try (FileWriter fw = new FileWriter("/Temenos/T24/UD/SHIBLI.BP/JBLcustomerRecords.csv", true);
