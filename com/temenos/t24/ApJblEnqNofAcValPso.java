...
/**
 * TODO:    API for Account validation:  
 *              EB.API>NOF.JblEnqNofAcValPso
                STANDARD.SELECTION>NOFILE.JBL.PSOPSP.ACCVAL
                ENQUIRY>AC.API.JBL.PSOPSP.ACCOUNT.VALIDATION.1.0.1
 *
 * @author MD Shibli Mollah
 *
 */
public class ApJblEnqNofAcValPso extends Enquiry {
    ...
    public List<String> setIds(List<FilterCriteria> filterCriteria, EnquiryContext enquiryContext) {
        ...
        try {
            ...
            if (phoneNo.equals("") || phoneNo.equals(null)) {
                phoneNo = "Phone number is not found";
                return accValInfo;
            }
        } catch (Exception e) {
            return accValInfo;
        ...
        if (valid == true && selPhoneNumber.equals(phoneNo) && selNidNo.equals(nidNo)) {
            ...
            try {
                ...
                if (legacyAcctNo.equals("") || legacyAcctNo.equals(null)) {
                    legacyAcctNo = "Legacy account is not found";
                }
            } catch (Exception e) {
                legacyAcctNo = "Legacy account is not found";
            }
